...
import { createPlant, type PlantFormState } from "../actions";
import { Button } from "@/components/ui/button";
import { Input } from "@/components/ui/input";
import { Label } from "@/components/ui/label";
import { PLANT_TYPES, CITRUS_CULTIVARS } from "@citrus/shared";

const initial: PlantFormState = {};

export function NewPlantForm() {
  const [state, formAction, pending] = useActionState(createPlant, initial);
